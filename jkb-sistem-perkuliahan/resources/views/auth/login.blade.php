...
{{-- Login --}}
    ...
    <body>
        ...
        <x-input-error :messages="$errors->get('sso')" class="mt-2 text-center" />
            ...
            <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto h-screen">
                ...
                <div class="w-full p-8 lg:w-1/2">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('sso.redirect') }}" class="block text-center bg-blue-600 text-white font-bold py-2 px-4 w-full rounded hover:bg-blue-500">Login dengan SSO</a>
                    </div>
                    </form>
