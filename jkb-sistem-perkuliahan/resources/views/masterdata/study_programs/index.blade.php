                            ...
                            @forelse ($data as $a)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-3 py-2 flex space-x-2 justify-center ">
                                        ...
                                        <button type="button" id="btn-hapus{{ $a->id }}" class="font-medium bg-red-600 text-white px-3 py-2 rounded-md hover:bg-red-700 transition duration-300 hover:underline" onclick="openModal('{{ $a->id }}', '{{ route('masterdata.study_programs.destroy', $a->id) }}')">
