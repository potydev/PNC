...
<div>
    ...
    <header class="sticky top-0 bg-white shadow">
        <div class="container flex flex-col sm:flex-row justify-between items-center mx-auto py-4 px-8">
            ...
            <div class="hidden md:block">
                <button type="button"
                    class=" py-3 px-8 text-sm bg-indigo-500 hover:bg-indigo-600 rounded text-white ">Start Free
                    Trial
                </button>
            </div>
        </div>
    ...
    <main class="text-gray-900">
                    ...
                    <p class="mt-8 md:mt-12">
                        @if (Route::has('login'))
                                ...
                                @auth
                                 <a
                                        href="{{ url('/dashboard') }}"
                                class=" py-4 px-12 bg-indigo-500 hover:bg-indigo-600 rounded text-white"> Dashboard</a>
                                    
                                @else
                                    
                                    <a href="{{ route('login') }}"
                                    class=" py-4 px-12 bg-indigo-500 hover:bg-indigo-600 rounded text-white"> Log in</a>
                                @endauth
                        @endif
            ...
            <div class="container mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row mt-8 lg:px-24">
                    <div class="w-full sm:w-1/3">
                        <p class="text-4xl lg:text-6xl font-semibold text-indigo-500">+100%
                        </p>
        ...
        <section class="container mx-auto my-20 py-24 bg-gray-200 rounded-lg text-center">
            ...
            <p class="mt-8">
                <button type="button"
                    class=" py-5 px-16 text-lg bg-indigo-500 hover:bg-indigo-600 rounded text-white ">Get Started
                    Now
                </button>
            </p>
        </section>
