<div class="flex flex-col gap-2">
    @section('main_folder', 'Undur Diri Mahasiswa')
    @section('title-page', 'Data Undur Diri Mahasiswa')
    <div
        ...
        <div class="flex gap-2">
            <button id="openCreateModal" wire:click="$dispatch('create-resignation')"
            ...
            <livewire:resignations.form />
        </div>
    </div>
    <div
        class="w-full bg-white border shadow p-4 rounded-lg">
        <livewire:resignation-table :advisor-id="Auth::user()->lecturer->id"/>
    </div>
</div>