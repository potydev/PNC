<div class="flex flex-col gap-2">
    @section('main_folder', 'Peringatan Mahasiswa')
    @section('title-page', 'Data Peringatan Mahasiswa')
    <div
        ...
        <div class="flex gap-2">
            <button id="openCreateModal" wire:click="$dispatch('create-warning')"
            ...
            <livewire:warnings.form :date-end="$dateEnd" />
        </div>
    </div>
    <div
        class="w-full bg-white border shadow p-4 rounded-lg">
       <livewire:warning-table :class-filters="$classFilters" :advisor-id="Auth::user()->lecturer->id"/>
    </div>
</div>