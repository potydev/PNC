<div class="flex flex-col gap-2">
    ...
    <div
        ...
        <div class="flex gap-1 items-center">
            ...
            <span class="text-sm">Menampilkan data Pengguna</span>
        </div>
        <!-- Bagian tombol -->
        <div class="flex gap-2">
            <button id="openCreateModal" wire:click="$dispatch('create-user')"
            ...
            <livewire:masterdata.users.form />
        </div>
    </div>
    <div
