...
final class TuitionArrearTable extends PowerGridComponent
{
    public string $tableName = 'tuition-arrear-table-noefm8-table';
    ...
    {
        $query = TuitionArrear::query()->with('student');
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('amount_formatted', function ($model) {
                return 'Rp. ' . number_format($model->amount, 2, ',', '.');
            })
            ->add('semester')
            ->add('created_at');
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Nama', 'name')
                ->searchable(),
            Column::make('Jumlah Tunggakan', 'amount_formatted')
                ->sortable()
                ->searchable(),
    ...
    public function actions(TuitionArrear $row): array
    {
        ...
        $deleteButton = Button::add('delete')
                ...
                ->attributes([
                        ...
                        'data-text' => 'Data Tunggakan UKT akan dihapus permanen.'
                ]);
